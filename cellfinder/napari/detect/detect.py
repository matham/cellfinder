...
def debug_results_callback(
    ...
    for tp, data_path, name, stage, dtype in [
        ...
        (
            "labels",
            detect_debug.bin_2d_peaks_image_path,
            "2D thresholded peaks",
            DetectionStage.bin_2d_peaks,
            detect_debug.settings.detection_dtype,
        ),
        (
            "labels",
            detect_debug.bin_3d_peaks_image_path,
            "3D thresholded peaks",
            DetectionStage.bin_3d_peaks,
            detect_debug.settings.detection_dtype,
        ),
        (
            "labels",
            detect_debug.filtered_3d_ball_image_path,
            "3D ball filtered",
            DetectionStage.filtered_3d_ball,
            detect_debug.settings.detection_dtype,
        ),
        (
            "labels",
            ...
            "Structures ID",
            DetectionStage.structs_detection,
            None,
        ),
        (
            "labels",
            ...
            "Structures type",
            DetectionStage.struct_typed,
            None,
        ),
        (
            "labels",
            detect_debug.struct_type_split_image_path,
            "Structures type after split",
            DetectionStage.struct_splitting,
            None,
        ),
    ]:
